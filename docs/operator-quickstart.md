# Operator Quickstart — Community Building Construction
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4100.git
cd cloud-itonami-isic-4100
```
...
- Blueprint governor key: `building-construction-governor`
- Likely source path: `building.governor.cljc`
