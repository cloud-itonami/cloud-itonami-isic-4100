...
## Classification
- Repository: `cloud-itonami-isic-4100` ([github.com/cloud-itonami/cloud-itonami-isic-4100](https://github.com/cloud-itonami/cloud-itonami-isic-4100))
- ISIC Rev.5: `4100` — Community Building Construction
- Domain: `:construction/buildings`
- Social impact: :housing-access :worker-safety :local-industry
- Actor: `:building-construction-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :construction/buildings — who wants
...
One managed tenant (:construction/buildings):
...
- Do not bypass the `:building-construction-governor` for production decisions.
